/* global CoffeeMachine, document, Beverage */
...
(function () {
    ...
    for (var i = 0; i < buttons.length; i++) {
        buttons[i].addEventListener("click", function () {
            var beverageName = this.getAttribute("data-beverage");
    ...
    reloadBtn.addEventListener("click", (event) => window.location.reload(true))
