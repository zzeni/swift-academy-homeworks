...
(function () {
    ...
    function fetch(partialName) {
        ...
        window.setTimeout(function () {
            $(".modal-body").load(template, function () {
    ...
    $("a[data-click='mygame']").on("click", function () {
        fetch("mygame");
        $('#toptitleh2').html('My Game');
    });

    $("a[data-click='contactme']").on("click", function () {
        fetch("contactme");
        $('#toptitleh2').html('Contact Me');
    });

    $("a[data-click='myproducts']").on("click", function () {
        fetch("myproducts");
        $('#toptitleh2').html('My Products');
    });

    $("a[data-click='aboutme']").on("click", function () {
        fetch("aboutme");
        $('#toptitleh2').html('About Me');
    });

    $("a[data-click='thanksto']").on("click", function () {
        fetch("thanksto");
        $('#toptitleh2').html('Thanks To');
    });
